...
export function MarkdownRenderer({ children, components = {}}: { children: React.ReactNode , components?: Components }) {
  ...
  return (
    <div className="prose prose-base prose-neutral dark:prose-invert max-w-none break-words prose-headings:font-semibold prose-a:text-primary prose-a:break-all prose-code:before:content-none prose-code:after:content-none prose-pre:p-0 prose-pre:bg-transparent prose-p:mb-4 prose-p:leading-7 prose-li:mb-2">
        <ReactMarkdown
